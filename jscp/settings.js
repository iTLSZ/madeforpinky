...
let settings = {
    music: './music/Silvestre Dangond - Una Vaina Bien.mp3',
    countdown: 3,
    matrixText: 'HAPPYBIRTHDAY',
    matrixColor1: '#ff69b4', // Màu pink mẫu
    matrixColor2: '#ff1493', // Màu pink mẫu
    sequence: 'HAPPY|BIRTHDAY|TO|PINKY|❤',
    sequenceColor: '#ff69b4', // Màu pink mẫu
    gift: '',
    enableBook: false,
    pages: [
        { image: './image/1.jpeg' },
        { image: './image/2.jpeg', content: 'Feliz cumpleaños Mi Amor 💗' },
        { image: './image/3.jpeg' },
        { image: './image/4.jpeg' },
        { image: './image/5.jpeg' },
        { image: './image/6.jpeg' },
        { image: './image/7.jpeg', content: 'Mientras sonías, yo seré feliz. ¡Sigue sonriendo!' }
    ],
    enableHeart: true,
};
...
const musicOptions = [
    { value: './music/Silvestre Dangond - Una Vaina Bien.mp3', label: 'Una Vaina Bien - Silvestre Dangond' },
...
function initializeDefaultSettings() {
    ...
    // ----------------------------------------------------------------------
    // AQUÍ PUEDES CONFIGURAR TUS FOTOS Y TEXTOS PERMANENTEMENTE
    // ----------------------------------------------------------------------
    window.settings = {
        music: './music/Silvestre Dangond - Una Vaina Bien.mp3',
        countdown: 3,
        ...
        colorTheme: 'pink',
        pages: [
            { image: './image/1.jpeg', content: '' },
            { image: './image/2.jpeg', content: 'Feliz cumpleaños mi amor 💗' },
            { image: './image/3.jpeg', content: '' },
            { image: './image/4.jpeg', content: '' },
            { image: './image/5.jpeg', content: '' },
            { image: './image/6.jpeg', content: '' },
            { image: './image/7.jpeg', content: 'Mientras sonías, yo seré feliz. ¡Sigue sonriendo!' }
        ]
    };
    // ----------------------------------------------------------------------
...
function applyLoadedSettings() {
    ...
    // Apply music settings — actualizar tanto el <audio> como el <source> interno
    const birthdayAudio = document.getElementById('birthdayAudio');
    if (birthdayAudio && settings.music) {
        const sourceEl = birthdayAudio.querySelector('source');
        if (sourceEl) {
            sourceEl.src = settings.music;   // actualizar el <source>
        }
        birthdayAudio.src = settings.music;  // también el <audio> directamente
        birthdayAudio.load();                // forzar que el navegador recargue el archivo
        // Iniciar la música al abrir la página (desde min 1:00)
...
// Cargar configuración solo desde datos locales (sin base de datos ni API)
function loadWebsiteFromServer() {
...
applySettingsButton.addEventListener('click', () => {
    ...
    settings.sequence = document.getElementById('sequenceText').value || 'HAPPY|BIRTHDAY|TO|PINKY|❤';
